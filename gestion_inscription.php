...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($mdp !== $confirm_mdp) { 
        ...
        if ($connexion->query($sql_insert_user) === TRUE) {
            ...
            $sql_insert_client = "INSERT INTO client (nom, prenom, email, adr, tel, types, siret, statut, mdp) VALUES ('$nom', '$prenom', '$email','$adr', '$tel','$types','$siret','$statut', '$hashed_password' )";
